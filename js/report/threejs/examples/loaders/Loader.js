        ...
        switch ( extension ) {
            ...
            case 'awd':
                ...
                reader.addEventListener( 'load', function ( event ) {
                    ...
                    globalObj.loadedObjects.push(scene2);
                    scene.add(scene2);
            ...
            case 'babylon':
                ...
                reader.addEventListener( 'load', function ( event ) {
                    ...
                    globalObject.loadedObjects.push(scene2);
                    scene.add(scene2);
                    //editor.execute( new SetSceneCommand( editor, scene ) );
            ...
            case 'babylonmeshdata':
                ...
                reader.addEventListener( 'load', function ( event ) {
                    ...
                    mesh.name = filename;
                    globalObj.loadedObjects.push(mesh);
                    scene.add(mesh);
            ...
            case 'glb':
                ...
                reader.addEventListener( 'load', function ( event ) {
                    ...
                    loader.parse( contents, '', function ( result ) {
                        ...
                        var scene2 = result.scene;
                        scene2.name = filename;
                        globalObj.loadedObjects.push(scene2);
                        scene.add(scene2);
            ...
            case 'wrl':
                ...
                reader.addEventListener( 'load', function ( event ) {
                    ...
                    globalObj.loadedObjects.push(result);
                    scene.add(result);
